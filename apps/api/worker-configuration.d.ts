/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 832a3c927984243ede5299bee494a6e2)
...
interface __BaseEnv_Env {
	...
	ADMIN_TOKEN: string;
	ENVIRONMENT: string;
	GROUP_CHAT: DurableObjectNamespace<import("./src/index").GroupChat>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GroupChat";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "EMAIL_FROM_NAME" | "VAPID_SUBJECT" | "JWT_SECRET" | "ADMIN_TOKEN" | "ENVIRONMENT">> {}
}
